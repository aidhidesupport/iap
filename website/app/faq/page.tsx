...
export default function FAQ() {
  return <Guide title="試す前に、知っておきたいこと。" label="FAQ" lead="IAPはpartial-standardsの活動として提案している仕様草案です。最初の実装例であるCodex連携を中心に、役割・できること・利用条件をまとめました。" sections={[
    ...
    <Section id="start" title="01 — 誰が、どう試すか">
      ...
      <h3>システムは完成していますか？</h3><p>完成条件との照合、修正・再確認、共有文生成、古い評価の失効、休止・復帰といった中核機能は実装済みで、試験版として公開しています。他の人の導入や、実際の負担軽減は未検証です。配布物0.2.5の自動テストと、0.2.4の実Codexの動作記録を分けて公開し、0.2.5での実動作の再確認を次の技術確認にしています。</p><TextLink href="/status">実装と検証の現在地</TextLink>
