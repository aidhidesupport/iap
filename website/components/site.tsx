...
export function Footer() {
  return <footer className="site-footer wrap"><div><Link href="/" className="footer-brand">IAP</Link><p>Interaction Accommodation Protocol<br/>対話・協働の条件調整プロトコル<br/>A proposal from partial-standards</p></div><div><a href="https://github.com/aidhidesupport/iap">仕様草案・GitHub <ArrowUpRight size={15}/></a><nav className="footer-links" aria-label="補足ガイド"><Link href="/faq">よくある質問</Link><Link href="/updates">配布・更新と活動報告</Link></nav><p>維持・編集：aidhidesupport<br/>ローカル連携版 0.2.5 · 2026.09.22</p></div></footer>;
}
